...
<header class="header">
    <div class="container">
        <div class="header-top">
            ...
            <a href="/LosMedical/?lang=ru" class="header-logo">
                <img  src="images/logo.png" alt="">
                <span class="header-logo-text ru">LosMedical</span>
            </a>
            ...
            $url = explode('?', $url);
            $url = $url[0];
            $QS = http_build_query(array_merge($_GET, ["lang"=>"ua"]));
            $pathLang = $url.'?'.$QS;
            ?>
        ...
        <nav class="nav">
            <a href="/LosMedical/?lang=ru" class="nav-link">Главная</a>
            <a href="/LosMedical/?page=doctors&lang=ru" class="nav-link">Наши доктора</a>
            <a href="/LosMedical/?page=contacts&lang=ru" class="nav-link">Контакты</a>
        </nav>
